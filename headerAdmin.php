						...
						<ul class="nav navbar-nav">
							<li class="dropdown"> 
								...
								<ul class="dropdown-menu">
									<li><a  href="indexAdmin.php">ACTUALITES</a></li>
							...
							<li class="dropdown"> 
								<a id="parentsDeroulant" data-toggle="dropdown" href="#">GESTION PERSONNELS</a>
								<ul class="dropdown-menu">
									<li><a  href="ajouterPersonnel.php">AJOUTER PERSONNEL</a></li>
									<li><a  href="modifierPersonnel.php">MODIFIER PERSONNEL</a></li>
									<li><a  href="supprimerPersonnel.php">SUPPRIMER PERSONNEL</a></li>									
								</ul>
							</li>
							<li class="dropdown"> 
								<a id="activitesDeroulant" data-toggle="dropdown" href="#">ACTIVITES</a>
								<ul class="dropdown-menu">
									<li><a  href="ajouterPersonnel.php">AJOUTER ACTIVITE</a></li>
									<li><a  href="modifierPersonnel.php">MODIFIER ACTIVITE</a></li>
									<li><a  href="supprimerPersonnel.php">ANNULER ACTIVITE</a></li>									
								</ul>
							</li>
